...
PaletteError:
  ...
  Sub GetInputs(Player1$, Player2$, NumGames As Integer)
    ...
    LOCATE(8, 15)
    LINEINPUT("Name of Player 1 (Default = 'Player 1'): ", SEMICOLON, Player1$)
    If Player1$ = "" Then
      Player1$ = "Player 1"
    Else
    ...
    LOCATE(10, 15)
    LINEINPUT("Name of Player 2 (Default = 'Player 2'): ", SEMICOLON, Player2$)
    If Player2$ = "" Then
      Player2$ = "Player 2"
    Else
    ...
    Do
      ...
      LOCATE(12, 13)
      INPUT("Play to how many total points (Default = 3)", SEMICOLON, game$)
    ...
    Do
      ...
      LOCATE(14, 17)
      INPUT("Gravity in Meters/Sec (Earth = 9.8)", SEMICOLON, grav$)
      gravity# = VAL(grav$)
